...
describe('formatDate', () => {
    ...
    it('should return the right formatted date', () => {
        expect(formatDate(new Date(2019, 3, 24))).toBe('April 24, 2019');
        expect(formatDate(new Date('04/24/2019'))).toBe('April 24, 2019');
        expect(formatDate('04/24/2019')).toBe('April 24, 2019');
    });
    ...
    it('should return the right formatted date when formatStyle is wrong', () => {
        expect(formatDate(new Date(2019, 3, 24), 'normal')).toBe('April 24, 2019');
        expect(formatDate(new Date('04/24/2019'), 'big')).toBe('April 24, 2019');
        expect(formatDate('04/24/2019', 'short')).toBe('April 24, 2019');
    });
});
